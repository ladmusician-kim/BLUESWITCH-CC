...
static uint8 simpleProfileChar1UserDesp[MAX_LENGTH_CHARATERISTIC_VALUE] = "Characteristic 1\0";
...
static uint8 simpleProfileChar2UserDesp[MAX_LENGTH_CHARATERISTIC_VALUE] = "Characteristic 2\0";
...
static uint8 simpleProfileChar3UserDesp[MAX_LENGTH_CHARATERISTIC_VALUE] = "Characteristic 3\0";
...
static uint8 simpleProfileChar4UserDesp[MAX_LENGTH_CHARATERISTIC_VALUE] = "Characteristic 4\0";
...
static uint8 simpleProfileChar5UserDesp[MAX_LENGTH_CHARATERISTIC_VALUE] = "Characteristic 5\0";
...
void BSProfile_notifyCharateristicChanged( uint8 param ) {
  switch ( param )
  {
  ...
  switch ( param )
  {
    case SIMPLEPROFILE_CHAR1:
      if ( len == sizeof ( uint8 ) ) 
      {
        ...
        BSProfile_notifyCharateristicChanged(SIMPLEPROFILE_CHAR1);
      }
      else
      {
        ret = bleInvalidRange;
    ...
    case SIMPLEPROFILE_CHAR4:
      if ( len == sizeof ( uint8 ) ) 
      {
        ...
        // See if Notification has been enabled
        BSProfile_notifyCharateristicChanged(SIMPLEPROFILE_CHAR4);
      }
      else
      {
        ret = bleInvalidRange;
  ...
  switch ( param )
  {
    case SIMPLEPROFILE_CHAR1:
      *((uint8*)value) = simpleProfileChar1;
      //*((uint8*)value) = simpleProfileAttrTbl[INDEX_CHAR_ONE_VALUE].pValue;
      break;
      ...
      case SIMPLEPROFILE_CHAR3_UUID:
        ...
        */
        ...
        if ( status == SUCCESS )
        {
          ...
          if(osal_memcmp(pCurValue, &simpleProfileChar1, len))
          {
