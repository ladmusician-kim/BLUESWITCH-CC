/**************************************************************************************************
  Filename:       OSAL_BSBLEPeripheral.c
...
const pTaskEventHandlerFn tasksArr[] =
{
  ...
  //timerInterface_ProcessEvent,
  parsingData_ProcessEvent,                                         // task 12
  BSBLEPeripheral_ProcessEvent                                      // task 13
};
...
void osalInitTasks( void )
{
  ...
  //timerInterface_Init( taskID++ );
  parsingData_Init( taskID++ );
    
  /* Application */
  BSBLEPeripheral_Init( taskID );
}
